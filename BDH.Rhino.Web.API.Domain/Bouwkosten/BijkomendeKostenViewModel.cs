...
{
    public class BijkomendeKostenViewModel : IBijkomendeKostenProvider
    {
        ...
        public BijkomendeKostenViewModel()
        {

        }
        public BijkomendeKostenViewModel(IBijkomendeKostenProvider other) : this()
        {
